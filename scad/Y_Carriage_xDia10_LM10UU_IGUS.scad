...
module support_low() {
   ...
   multmatrix(m = [[1, 0, 0, -20],
                   ...
                   [0, 0, 1, 0],
                   [0, 0, 0, 1]]) difference() {
      linear_extrude(20) offset(r=5) offset(r=-5)
   ...
   difference() {
      translate([-20,0,-5]) linear_extrude(4.6) offset(r=5) offset(r=-5)
         polygon([[-17.5,-17.5],[17.5,-17.5],[31.5,-3.5],[31.5,3.5],
                  [17.5,17.5],[-17.5,17.5],[-31.5,3.5],[-31.5,-3.5]]);
      translate([-12.5,-35,-6]) cube([60,70,100],false);
   }
}
...
module y_carriage_base() {
   difference() {
      union() {
         // body
        rotate([90,0,0]) cylinder(d=23,h=35,center=true);
         difference() {
      ...
      // low cut
      translate([0,0,-10-5]) cube([100,100,20],true);
      // y belt
      translate([-5.5,0,15.25]) cube([9,40,5.5],true);
      // y rail
      rotate([0,0,90]) for(y=[0]) {
         translate([-28,y,0]) rotate([0,90,0]) cylinder(d=19.2-0.6,h=56,center=false);
         translate([-28,y,0]) rotate([0,90,0]) cylinder(d=19.2,h=17.3,center=false);
         translate([-9.9,y,0]) rotate([0,90,0]) cylinder(d=19.2,h=19.8,center=false);
         translate([10.7,y,0]) rotate([0,90,0]) cylinder(d=19.2,h=17.3,center=false);
      }
//      translate([0,0,-0.5]) rotate([90,0,0]) cylinder(d=20,h=40,center=true);
      // x rails
      for(x_pos = [-22.5,22.5]) {
         translate([x_pos,0,0]) cylinder(d=10.2,h=100,center=true);
      }
      // xy belt1
      intersection() {
